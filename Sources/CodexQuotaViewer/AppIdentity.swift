...
enum AppIdentity {
    static let packageName = "CodexQuotaViewer"
    static let displayName = "Codex Quota Viewer"
    static let bundleIdentifier = "dev.codex.quotaviewer"
    ...
    static let rpcClientVersion = "0.2.1"
